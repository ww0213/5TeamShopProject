...
<html data-wf-page="650071e17cd3c26438525ffa" data-wf-site="64e5ed3359b16400aec286b0">
<head>
  <meta charset="utf-8">
...
<body class="body-13">
  ...
  <div class="pag18977722y">
    ...
    <div class="section">
      <div class="wrapper">
        <div data-node-type="commerce-order-confirmation-wrapper" data-wf-order-query="" data-wf-page-link-href-prefix="" class="w-commerce-commerceorderconfirmationcontainer order-confirmation-156container-copy">
                ...
                <div class="w-commerce-commercelayoutsidebar order-sidebar">
                  <div class="w-commerce-commercecheckoutorderitemswrapper order-block-side">
                    <div class="w-commerce-commercecheckoutsummaryblockheader order-block-side-header">
                      ...
                      <div class="text-block-33">購買人:王小明</div>
                    </div>
                    <fieldset class="w-commerce-commercecheckoutblockcontent order-block-side-content">
                      <script type="text/x-wf-template" id="wf-template-625b37c8-6975-63ff-0314-a6d689476c2b"></script>
                  ...
                  <div class="w-commerce-commercecheckoutordersummarywrapper order-block-side">
                    <div class="w-commerce-commercecheckoutsummaryblockheader order-block-side-header">
                      <h5 class="no-margin">總價:000.00元</h5>
                      <a href="#" class="button-11 w-button">前往支付頁面</a>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div class="container">
        <div class="footer-wrapper-two">
          ...
          <div class="footer-form w-form">
            <form id="wf-form-Footer-Form" name="wf-form-Footer-Form" data-name="Footer Form" method="get" class="footer-form-container" data-wf-page-id="650071e17cd3c26438525ffa" data-wf-element-id="86c8691c-5269-34ae-c278-3a6e48f4a662">
