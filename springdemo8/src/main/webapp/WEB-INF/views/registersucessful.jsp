...
<html data-wf-page="64fbe9026b4ef83f4ebfe3f1" data-wf-site="64e5ed3359b16400aec286b0">
<head>
  <meta charset="utf-8">
  <title>註冊成功</title>
  ...
  <div class="page-wrapper-77py">
    ...
    <div class="section no-padding-vertical">
      ...
      <div class="w-layout-blockcontainer container-30pycopy w-container">
        ...
        <div class="text-block-21"><strong class="bold-text">請按下方按鈕立即登入</strong></div>
    ...
    <div class="container">
      <div class="footer-wrapper-two">
        ...
        <div class="footer-form w-form">
          <form id="wf-form-Footer-Form" name="wf-form-Footer-Form" data-name="Footer Form" method="get" class="footer-form-container" data-wf-page-id="64fbe9026b4ef83f4ebfe3f1" data-wf-element-id="f441a17e-0218-ad41-4792-bb1474696d31">
