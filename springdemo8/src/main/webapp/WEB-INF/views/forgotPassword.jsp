...
<html data-wf-page="64fbe9026b4ef83f4ebfe3a8"
				...
				<div class="wrapper nav-bar-wrapper">
					...
					<div class="navigation">
						<nav role="navigation" class="nav-menu w-nav-menu">
							...
							<a href="/" class="nav-link w-nav-link">社區</a> <a
								href="/" class="nav-link w-nav-link">消息新聞</a>
							<div>
								<img
									src="../images/螢幕擷取畫面_2023-09-02__1_-removebg-preview-removebg-preview.png"
									loading="lazy" width="68"
									sizes="(max-width: 991px) 100vw, (max-width: 1439px) 6vw, 67.99715423583984px"
									alt=""
							...
							<a
								href="../member-profile/member-profile-ame-library-friend-list.html"
								class="nav-link w-nav-link">會員中心</a> <a href="/"
								class="nav-link w-nav-link">註冊</a> <a href="/"
			...
			<div class="w-layout-blockcontainer container-3249opy w-container">
				...
				<div class="w-form">
					<form:form
						...
						method="POST">
						<div>
							<!-- Email input field with client-side validation for email format -->
							<label for="email">電子郵件</label> <input type="email" id="email"
								name="email" required>
						</div>
						<!-- Submit button for the form -->
						<button type="submit"  class="submit-button-4 w-button">送出</button>
					</form:form>

					<!-- JSP conditional tag to check for the presence of an error message and display it -->
					<c:if test="${not empty error}">
						<div class="error">${error}</div>
					</c:if>

					<!-- JSP conditional tag to check for the presence of a success message and display it -->
					<c:if test="${not empty forgotSuccess}">
						<div class="success">A new password has been sent to your
							email.</div>
					</c:if>
			...
			<div class="footer-wrapper-two">
				...
				<div class="footer-form w-form">
					<form id="wf-form-Footer-Form" name="wf-form-Footer-Form"
						...
						data-wf-page-id="64fbe9026b4ef83f4ebfe3a8"
						data-wf-element-id="f441a17e-0218-ad41-4792-bb1474696d31">
						...
						<div class="footer-form-block">
							<input type="email" class="footer-form-field w-input"
								...
								placeholder="Get product updates" id="Footer-Email" required=""><input
								type="submit" value="" data-wait="Please wait..."
