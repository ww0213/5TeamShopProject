        ...
        <div class="navigation">
          <nav role="navigation" class="nav-menu w-nav-menu">
            ...
            <div data-hover="false" data-delay="0" class="dropdown w-dropdown">
              ...
              <nav class="w-dropdown-list">
                <a href="" aria-current="page" class="dropdown-link w-dropdown-link w--current">個人資料</a>
            ...
            <div data-w-tab="Tab 1" class="f-tab-pane-2-copy w-tab-pane w--tab-active">
                ...
                <c:choose>
					...
					<c:when test="${itemPictureBase64 != null}"> 
						...
						<div class="f-margin-bottom-71"><img width="300" sizes="(max-width: 479px) 53vw, 300px" src="data:image/jpeg;base64,${itemPictureBase64}" loading="lazy" alt=""   class="image-46">
             
					</c:when>
											   
					<c:otherwise>  

						<div class="f-margin-bottom-71"><img width="300" sizes="(max-width: 479px) 53vw, 300px" src="images/avatar.png" loading="lazy" alt=""   class="image-46">
                ...
                <div id="w-node-c764d726-9e84-740d-1833-c6421cce6708-38525fdc" class="f-career-row-wrapper">
                  <div class="w-layout-grid f-career-row">
                    ...
                    <div id="w-node-c764d726-9e84-740d-1833-c6421cce6710-38525fdc" class="div-block-19">
                      <a href="/updatep_Profile?id=${user.id}&userId=${user.id}" class="f-careers-text-link test123">修改資料</a>
                    </div>
                  </div>
                </div>
...
<%--                       <div class="f-paragraph-regular-4 f-text-color-gray-500">${user.username}</div> --%>
<!--                     </div> -->
<!--                   </div> -->
<!--                 </div> -->
...
<%--                       <div class="f-paragraph-regular-4 f-text-color-gray-500">${user.password}</div> --%>
<!--                     </div> -->
                ...
                <div id="w-node-c764d726-9e84-740d-1833-c6421cce6729-38525fdc" class="f-career-row-wrapper">
                  <div class="w-layout-grid f-career-row">
                    ...
                    <div id="w-node-c764d726-9e84-740d-1833-c6421cce672e-38525fdc">
                      <div class="f-paragraph-regular-4 f-text-color-gray-500">${user.email}</div>
                    </div>              
                  </div>
                </div>
              </div>
