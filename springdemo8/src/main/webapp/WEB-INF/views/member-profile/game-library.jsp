...
<head>
  ...
  <link rel='stylesheet' ef="<c:url value='/css/normalize.css' />"  type="text/css" />
          ...
          <nav role="navigation" class="nav-menu w-nav-menu">
            ...
            <div data-hover="false" data-delay="0" class="dropdown w-dropdown">
              ...
              <nav class="w-dropdown-list">
                ...
                <a href="/findPlayergameid?id=${sessionScope.myUser.id}" aria-current="page" class="dropdown-link-3 w-dropdown-link w--current">遊戲庫</a>
              ...
              <div class="w-form">
                <form id="email-form" name="email-form" data-name="Email Form" method="get" data-wf-page-id="650071e17cd3c26438525fbb" data-wf-element-id="2e03cfcb-863e-5fa6-2805-e2c9f376aff4">
                  <div class="f-section-large-4">
									...
									<!--取得登入者名稱 -->     
                    	<div class="f-tab-heading" style="text-align: center;margin-left: 200px;">${sessionScope.myUser.username}的遊戲庫</div>
                    ...
                    <c:forEach var="emp" items="${PlayergameList}">                     
                        <div id="w-node-_3312d92e-faf2-08be-9a7b-5419081d2405-33d6b7f8">
	                        <div id="w-node-bbee6cab-9e70-d3fa-675b-cde93084cac8-33d6b7f8" class="text-block-13">
	                          <a href="<c:url value='/findgameid?id=${emp[0]}' />" style="text-decoration: none;">${emp[3]}</a>
	                        </div>
		                    <a href="<c:url value='/findgameid?id=${emp[0]}' />" class="f-gallery-lightbox w-inline-block">
		                       <img alt="" loading="lazy" src="${emp[4]}" class="f-image-cover-3">
		                    </a>               
                  		</div>
                  	</c:forEach>
