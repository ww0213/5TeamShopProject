...
<%--         <c:set var="picture"  				value = "${employee.dataUri}" /> --%>
    </c:otherwise>
        ...
        <div class="navigation">
          <nav role="navigation" class="nav-menu w-nav-menu">
            ...
            <div data-hover="false" data-delay="0" class="dropdown w-dropdown">
              ...
              <nav class="w-dropdown-list">
                <a href="/findEmployee.do?id=${sessionScope.myUser.id}&userId=${sessionScope.myUser.id}" aria-current="page" class="dropdown-link w-dropdown-link w--current">個人資料</a>
    ...
    <div class="f-container-regular-2">
      <div class="f-career-wrapper">
        <div data-duration-in="300" data-duration-out="100" data-current="Tab 1" data-easing="ease" class="f-tab-copy w-tabs">
         ...
         <c:url var='updateUrl' value='/updateEmployee.do' />
     	 <form:form method='POST' action="${updateUrl}"  enctype="multipart/form-data">
          <input type="hidden" name="id" value="${id}"> 
<!--              <input type='hidden' id="picture" name='picture' value="" > -->
          <input type='file' id='inputFileToLoad' class='form-control' name='file'  style="display: none;">  
          <div class="w-tab-content">
            <div data-w-tab="Tab 1" class="f-tab-pane-2-copy w-tab-pane w--tab-active">
            
            <c:choose>

					<c:when test="${itemPictureBase64 != null}"> 

						 <div id="itemImage" class="f-margin-bottom-71"><img class="imaggess" width="300" sizes="(max-width: 479px) 53vw, 300px" src="data:image/jpeg;base64,${itemPictureBase64}" loading="lazy" alt=""   class="image-46">     
					...
					<c:otherwise>  
						...
						<div  id="itemImage" class="f-margin-bottom-71"><img style="cursor: pointer;" width="300" sizes="(max-width: 479px) 53vw, 300px" src="images/avatar.png" loading="lazy" alt=""   class="image-46">
             
					</c:otherwise> 
											  
				</c:choose>
<%--               <div style="display: inline-block;" id="itemImage" class="f-margin-bottom-71"><img class="imaggess" width="300" sizes="(max-width: 479px) 53vw, 300px" src="data:image/jpeg;base64,${itemPictureBase64}" loading="lazy" alt=""   class="image-46">      --%>
                
                 <script>
					    document.addEventListener("DOMContentLoaded", function() {
					        const itemImageDiv = document.getElementById("itemImage");
					        const inputFileToLoad = document.getElementById("inputFileToLoad");
					        const existingImage = document.querySelector("#itemImage img"); // 獲取現有的<img>元素
					
					        itemImageDiv.addEventListener("click", function() {
					            inputFileToLoad.click();
					        });
					
					        inputFileToLoad.addEventListener("change", loadImageFileAsDataURL);
					
					        function loadImageFileAsDataURL() {
					            ...
					            if (filesSelected.length > 0) {
					                ...
					                fileReader.onload = function (fileLoadedEvent) {
					                    let fileDataURL = fileLoadedEvent.target.result;
					                    existingImage.src = fileDataURL; // 更新<img>元素的 src 屬性
					                };
			...
			<div class="f-career-title-centre" >
                  <div class="f-margin-bottom-12">
                    <div class="f-heading-detail-small-4">${user.username} 您好</div>
                  </div>    
                  <div class="f-margin-bottom-12">
...
<%--                       <a href="/updatep_Profile?id=${user.id}" class="f-careers-text-link test123">修改資料</a> --%>
...
<%--                       <div class="f-paragraph-regular-4 f-text-color-gray-500"><input type='text' class='form-control' name='name' value="${name}" ></div> --%>
<!--                     </div> -->
<!--                   </div> -->
<!--                 </div> -->
                <div id="w-node-c764d726-9e84-740d-1833-c6421cce6713-38525fdc" class="f-career-row-wrapper">
                  <div class="w-layout-grid f-career-row">
                    ...
                    <div id="w-node-c764d726-9e84-740d-1833-c6421cce6718-38525fdc">
                      <div class="f-paragraph-regular-4 f-text-color-gray-500"><input type='text' class='form-control' name='username' value="${username}" ></div>
                    </div>
                  </div>
                </div>
                <div id="w-node-c764d726-9e84-740d-1833-c6421cce671e-38525fdc" class="f-career-row-wrapper">
                  <div class="w-layout-grid f-career-row">
                    <div>
                      <div class="f-paragraph-regular-4">請輸入新密碼</div>
                    </div>
                    <div id="w-node-c764d726-9e84-740d-1833-c6421cce6723-38525fdc">
                      <div class="f-paragraph-regular-4 f-text-color-gray-500"><input type='text' class='form-control' name='password' required value="" ></div>
                    </div>
                  </div>
                </div>
                <div id="w-node-c764d726-9e84-740d-1833-c6421cce6729-38525fdc" class="f-career-row-wrapper">
                  <div class="w-layout-grid f-career-row">
                    ...
                    <div id="w-node-c764d726-9e84-740d-1833-c6421cce672e-38525fdc">
                      <div class="f-paragraph-regular-4 f-text-color-gray-500"><input type='text' class='form-control' name='email' value="${email}" ></div>
                    </div>              
                  </div>
                </div>
              </div>
